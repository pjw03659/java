	...
	public static void main(String[] args) {
		...
		b1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				int result = x + y;
				JOptionPane.showMessageDialog(f, result,"덧셈 결과 창입니다.",JOptionPane.INFORMATION_MESSAGE);
		...
		b2.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				int y = Integer.parseInt(s2);
				int result = x - y;
				JOptionPane.showMessageDialog(f, result,"뺄셈 결과 창입니다.",JOptionPane.INFORMATION_MESSAGE);
		...
		b3.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				int y = Integer.parseInt(s2);
				int result = x * y;
				JOptionPane.showMessageDialog(f, result,"곱셈 결과 창입니다.",JOptionPane.INFORMATION_MESSAGE);
		...
		b4.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(f, String.format("%.3f", result),"나눗셈 결과 창입니다.",JOptionPane.INFORMATION_MESSAGE);
